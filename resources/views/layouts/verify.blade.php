...
<div class="navbar-ica bg-ica" style="z-index: 50 !important;">
    ...
    @elseif (Auth::user()->Clave_Rol=='2')
        <a class="navbar-brand ml-auto nav-name">
            <i class="fas fa-user-tie"></i>
            <h6 class="h6-less"><strong>Administrador de @yield('company','Compañia Sin Verificar'), {{ Auth::user()->Nombres }}</strong></h6>
        </a>
    ...
    @elseif (Auth::user()->Clave_Rol=='3')
        <a class="navbar-brand ml-auto nav-name" style="cursor: pointer">
            <i class="fas fa-user-tie"></i>
            <h6 class="h6-less"><strong>Usuario de @yield('company','Compañia Sin Verificar'), {{ Auth::user()->Nombres }}</strong></h6>
        </a>
        <a class="navbar-brand ml-auto nav-name" style="cursor: pointer">
    ...
    @elseif (Auth::user()->Clave_Rol=='4')
        <a class="navbar-brand ml-auto nav-name">
            <i class="fas fa-user-tie"></i>
            <h6 class="h6-less"><strong>PMO de @yield('company','Compañia Sin Verificar'), {{ Auth::user()->Nombres }}</strong></h6>
        </a>
        <a class="navbar-brand ml-auto nav-name" style="cursor: pointer">
            <div class="logout-button" href="{{ route('logout') }}" onclick="event.preventDefault(); document.getElementById('logout-form').submit();" style="text-align: right">
                <i class="fas fa-sign-out-alt"></i>

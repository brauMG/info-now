                                ...
                                <table class="table-responsive table-card-inline" id="tAdmin">
                                    ...
                                    <tr>
                                        <th for="inputGroupSelect01" class="th-card">
                                            <i class="fas fa-address-card"></i> Actividad Antecesora
                                        </th>
                                        <td class="td-card"> <select name="actividad" type="text" class="custom-select  @error('actividad') is-invalid @enderror" required>
                                                ...
                                                @endforeach
                                                @if($count ==0)
                                                    <option disabled selected>No hay actividades</option>
                                                @endif
                                            </select>
                                        </td>
                                    </tr>

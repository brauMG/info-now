    ...
    <div class="container container-rapi2">
        <main role="main" class="ml-sm-auto">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2 h2-less">Reporte de Usuarios en Proyectos</h1>
            </div>
        </main>
        <div id="Alert"></div>
    </div>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <div class="col-xl-12" style="padding-top: 1%;">
                    <form method="POST" action="{{route('UsersProjectsPDF')}}">
                        @csrf
                        <table class="table-responsive table-card-inline">
                            <thead class="thead">
                            <tr class="tr-card-complete" style="text-align: center">
                                <th scope="col" class="th-card filters-header filters-headers-mod"><i class="fas fa-project-diagram"></i> Proyectos</th>
                                <th scope="col" class="th-card filters-header filters-headers-mod"><i class="fas fa-globe-americas"></i> Fases</th>
                                <th scope="col" class="th-card filters-header filters-headers-mod"><i class="fas fa-users-cog"></i> Roles RASICS</th>
                            </tr>
                            </thead>
                                ...
                                <td class="td filters-act-stages filters-mod">
                                    ...
                                    @else
                                        @foreach($rasics as $rasic)
                                            <div class="form-check filters-projects-list">
                                                <input type="checkbox" class="form-check-input box-mod" id="exampleCheck1" name=rasics[]" value="{{$rasic->Clave}}">
                                                <label class="form-check-label" for="exampleCheck1">{{$rasic->RolRASIC}}</label>
                                            </div>
                                        @endforeach
                                    @endif
                                </td>
                            ...
                            <tr class="tr-card-complete" style="text-align: center">
                                ...
                                <th scope="col" class="th-card filters-header filters-headers-mod"><i class="fas fa-users"></i> Usuarios</th>
                                <th scope="col" class="th-card filters-header filters-headers-mod"><i class="fas fa-registered"></i> SER</th>
                            </tr>
                            </thead>
                            <tbody class="fonts" style="text-align: center">

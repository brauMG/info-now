<div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel">Nuevo Indicador</h5>
...
<script>
    $(document).ready(function(){
        ...
        $('#save').click(function(){            
            ...
            if(error==false){
                $.post('{{ url('/Admin/Indicador/Create')}}',{_token:token,descripcion:descripcion},function(data ){
                    ...
                    var node=table.rows
                    .add([{ 0:data.indicador.Clave, 1:descripcion,  2:'<div class="btn-group" role="group" aria-label="Basic example"><button type="button" class="btn btn-primary btn-sm edit" clave="'+data.indicador.Clave+'" onclick="edit(this);">Editar <i class="fas fa-edit"></i></button><button type="button" class="btn btn-danger btn-sm delete" clave="'+data.indicador.Clave+'" onclick="deleted(this);">Eliminar<i class="fas fa-trash-alt"></i></button></div>'}])
                    .draw()
                    .nodes();                

...
@section('content')
    ...
    <div class="container container-rapi2">
        <main role="main" class="ml-sm-auto">
            <div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pt-3 pb-2 mb-3 border-bottom">
                <h1 class="h2 h2-less">Áreas</h1>
                <div class="btn-toolbar mb-2 mb-md-0">
                    <div class="btn-group mr-2">
                        <button type="button" class="btn-less btn btn-info" id="new" onclick="AddArea();"><i class="fas fa-plus"></i> Agregar Área</button>
                    </div>
                </div>
            </div>
        </main>
            ...
            <div class="col text-center">
                <table class="table table-striped table-bordered mydatatable">
                    ...
                    <tr>
                        ...
                        <th style="text-transform: uppercase">Compañia</th>
    ...
    <script>
        ...
        function edit(button){
            ...
            $('#myModal').load( '{{ url('/Admin/Areas/Edit') }}/'+clave,function(response, status, xhr){
                if ( status == "success" ) {
                    $('#myModal').modal('show');
                }
            } );
